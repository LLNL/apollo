...
#
#SBATCH --job-name="APOLLO:EXHAUSTIVE.1of2.1.cleverleaf.test"
#SBATCH -N 2
#SBATCH -t 300
#
export EXPERIMENT_JOB_TITLE="EXHAUSTIVE.1of2.0001.cleverleaf"  # <-- creates output path!
#
