...
#
#SBATCH --job-name="APOLLO:EXHAUSTIVE.2of2.1.cleverleaf.test"
#SBATCH -N 2
#SBATCH -t 300
#
export EXPERIMENT_JOB_TITLE="EXHAUSTIVE.2of2.0001.cleverleaf"  # <-- creates output path!
#
...
#
    ...
    printf "\tpolicy_index, app_ranks, input_deck, initial_model, time\n\n"
